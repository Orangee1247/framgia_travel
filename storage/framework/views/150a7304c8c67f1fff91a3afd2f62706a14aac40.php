...
<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('includes.submenu', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <!-- about-section -->
        ...
        <div class="container">
            ...
            <div class="about-section-grids">
                <div class="col-md-4 wthree-about-section-grid">
                    <img src="<?php echo e(asset('images/abt_pic.jpg')); ?>" alt=""/>
                </div>
                <div class="col-md-4 wthree-about-section-grid">
                    <h5>Why choose us</h5>
    ...
    <div class="agileits-w3layouts-specials" id="agileits-specials">
        ...
        <div class="special-grids">
            <div class="col-md-6 special-left l-grids">
                <figure class="effect-bubba">
                    <img src="<?php echo e(asset('images/4.jpg')); ?>" alt=""/>
                    <figcaption>
                        <h4>Tour</h4>
        ...
        <div class="where-spl">
            ...
            <div class="col-md-6 special-left l-right l-grids">
                <figure class="effect-bubba">
                    <img src="<?php echo e(asset('images/1.jpg')); ?>" alt=""/>
                    <figcaption>
                        <h4>Tour</h4>
        ...
        <div class="spl-bot">
            <div class="col-md-6 special-left spl-bot-right l-grids">
                <figure class="effect-bubba">
                    <img class="img-responsive" src="<?php echo e(asset('images/2.jpg')); ?>" alt=""/>
                    <figcaption>
                        <h4>Tour</h4>
    ...
    <div class="news-section" id="agileinfo-news">
        <div class="container">
            ...
            <div class="news-section-grids">
                <div class="col-md-4 w3ls-news-section-grid">
                    <img src="<?php echo e(asset('images/n1.jpg')); ?>" alt=""/>
                    <div class="info">
                ...
                <div class="col-md-4 w3ls-news-section-grid">
                    <img src="<?php echo e(asset('images/n2.jpg')); ?>" alt=""/>
                    <div class="info">
                ...
                <div class="col-md-4 w3ls-news-section-grid">
                    <img src="<?php echo e(asset('images/n3.jpg')); ?>" alt=""/>
                    <div class="info">
        ...
        <a class="see-more" href="#"><?php echo e(trans('label.seemore')); ?></a>
    </div>
    </div>
    </div>
    <!-- //news-section -->
    <div class="gallery text-center" id="wthree-gallery">
        ...
        <a class="see-more-1" href="<?php echo e(route('provinceList')); ?>"><?php echo e(trans('label.seemore')); ?></a>
    </div>
    <!-- //gallery -->
        ...
        <div class="container">
            ...
            <div class="team-w3ls-row">
                ...
                <div class="col-md-3 team-grids">
                    <img src="<?php echo e(asset('images/t1.jpg')); ?>" alt=""/>
                ...
                <div class="col-md-3 team-grids">
                    <img src="<?php echo e(asset('images/t2.jpg')); ?>" alt=""/>
                    <div class="img-caption">
                        <div class="img-text">
...
<?php $__env->startSection('script'); ?>
    <?php echo e(HTML::script('bower_components/jquery-colorbox/jquery.colorbox.js')); ?>

    <?php echo e(HTML::script('js/move-top.js', ['type' => 'text/javascript'])); ?>

    <?php echo e(HTML::script('js/easing.js', ['type' => 'text/javascript'])); ?>

    <?php echo e(HTML::script('js/home.js', ['type' => 'text/javascript'])); ?>
