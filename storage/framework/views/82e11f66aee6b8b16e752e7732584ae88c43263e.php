            ...
            <form action="" method="POST">
                    ...
                    <select name="proChoice[]" class="form-control select2" multiple required>
                        <?php $__currentLoopData = $provinces; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $province): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($province->id); ?>"
                                    <?php echo e(in_array($province->id, $choiceSArr) ? 'selected' : ''); ?>
                ...
                <div class="form-group date">
                    ...
                    <input name="time" type="text" class="form-control" id="datepicker"
                           value="<?php echo e($plann->time); ?>">
                </div>
                <div class="form-group">
                    <label>Description</label> &nbsp;
                    <i class="fa fa-pencil"></i>
                    <textarea class="form-control" rows="3" name="description"
                              autocomplete="off"><?php echo e($plann->description); ?></textarea>
                </div>
                <div class="form-group">
                    <div class="checkbox">
                        <label>
